...
const Home = () => {
  ...
  const projectsFilteredNew = projects.filter(
    (item) => item.type === "New Project"
  );
  const projectsFilteredCompleted = projects.filter(
    (item) => item.type === "Completed Projects"
  );
  const projectsFilteredUnder = projects.filter(
    (item) => item.type === "Under Construction"
  );
