        ...
        <div className={style.about}>
            <div className={style.aboutImageText}>
                <Swiper
                    ...
                    className="mySwiper"
                >
                    <SwiperSlide><img className={style.image} src={home1} alt="about"/></SwiperSlide>
                    <SwiperSlide><img className={style.image} src={home2} alt="about"/></SwiperSlide>
                    <SwiperSlide><img className={style.image} src={home3} alt="about"/></SwiperSlide>
                    <SwiperSlide><img className={style.image} src={home4} alt="about"/></SwiperSlide>
                </Swiper>
            ...
            <div className={style.projectContainer}  id='about'>
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className={style.swiperSecond}>
                            <p>We wish to consign our appreciation of excellent execution and client relationship
                                maintained by SNC. We express our contentment with M/s. SNC for maintaining for its keen
                                sense of adherence to Quality, safety and statutory compliances. SNC has set standards
                                by completing Jewargi canal remodeling project in record 90 days. We congratulate SNC
                                for future endeavors.</p>
                            <h3>Chief Engineer, Krishna Bhagya Jala Nigam Ltd, Canal Zone No.1, Bheemarayanagudi</h3>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className={style.swiperSecond}>
