...
const EnvSafetyQuality = () => {
  ...
  const servicesH = [
    ...
    "Timely implementation of quality projects",
    "Protection",
    "Communication",
    "Setting measurable goals",
  ];
  const servicesP = [
    "Environmental protection through pollution prevention and implementation\n" +
      "environmentally friendly practices to carry out our processes to minimize impact\n" +
      "on the environment.",
    "Satisfy applicable requirements and comply with related compliance obligations\n" +
      "with the field of our activity.",
    "Timely implementation of quality projects and raising the level\n" +
      "customer satisfaction.",
    "Protection of biodiversity and ecosystems.",
    "Communication of this policy to all interested parties associated\n" +
      "and stakeholders in business associations with us.",
    "Setting measurable goals for environmental improvement\n" +
    ...
    <div className={style.about}>
      ...
      <div className={s.liferayOverview}>
        <div className={s.liferayOverviewText}>
          ...
          <p>
            We at PranayTeja Engineers are engaged in designing infrastructure,
            construction and project management, we strive to continuous
            improvement of the quality management system and environment of our
            organization.
          </p>
        </div>
            ...
            <div key={index} className={s.service}>
              ...
              >
                ...
                {!selected.includes(el) ? (
                  ...
                  <h2
                    className={s.plus}
                    style={selected.includes(el) ? { color: "black" } : {}}
                  >
                    -
                  </h2>
                )}
