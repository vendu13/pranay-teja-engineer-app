                ...
                >
                    ...
                    >
                        ...
                        <ul className={style.menu}>
                            ...
                            >
                                <Link className={style.link} to='/gallery'>Gallery</Link>
                            </li>
                            <li
                                onMouseOver={() => {
                                    setStyleHeader(true)
                            ...
                            >
                                <Link className={style.link} to='/contact'>Contact Us</Link>
                            </li>
                            <li
                                onMouseOver={() => {
                                    setStyleHeader(true)
                            ...
                            >
                                <a className={style.link}  href="tel:+918792248928">For Enquiry: +918792248928</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    {showProjects &&
                        ...
                        >
                            ...
                            >
                                <li><Link className={style.link} to='/projects/new'>New Project</Link></li>
                                <li><Link className={style.link} to='/projects/completed'>Completed projects</Link></li>
                                <li><Link className={style.link} to='/projects/under-construction'>Under Construction</Link></li>
                            </ul>
                        </motion.div>
                    }
                </motion.nav>}
                        ...
                        <div className={style.mobileItems}>
                            ...
                            {part1 && <div className={style.mobilePart}>
                                <div className={style.mobileLinks}>
                                    ...
                                    <Link className={style.link} to='/projects/under-construction'
                                          onClick={() => {
                                              setIsMenuToggled(!isMenuToggled)
                                              setPart1(!part1)
                                          }}
