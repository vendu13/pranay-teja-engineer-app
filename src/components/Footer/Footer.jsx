        ...
        <div className={style.footer}>
            ...
            <div className={style.footerBlock}>
                <div className={style.links}>
                    <a target='_blank' href='/' style={{color: "white"}}><BsFacebook/></a>
                ...
                <div className={style.tech}>
                    ...
                    •
                    <Link to='/projects/new' style={{color: "white", textDecoration: 'none'}}>New Project</Link>
                    •
                    <Link to='/projects/completed' style={{color: "white", textDecoration: 'none'}}>Completed Projects</Link>
                    •
                    <Link to='/projects/under-construction' style={{color: "white", textDecoration: 'none'}}>Under Construction</Link>
                </div>
            </div>
            <div className={style.line}/>
            <div className={style.footerBlock}>
